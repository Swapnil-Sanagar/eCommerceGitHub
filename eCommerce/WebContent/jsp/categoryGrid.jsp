	...
	<body ng-controller="CategoryMenuController" ng-init="categoryId='<%= request.getParameter("categoryId")%>'">
		...
		<div id="main-container" class="container">
			<div class="row">
				...
				<!-- Product Filter Starts -->
					<div class="product-filter">
						<div class="row">
							<div class="col-md-4">
								<div class="display">
									<a href="<%=request.getContextPath()%>/jsp/categoryList.jsp?categoryId=<%= request.getParameter("categoryId")%>&categoryName=<%= request.getParameter("categoryName") %>&categoryDescription=<%= request.getParameter("categoryDescription") %>" >
										<i class="fa fa-th-list" title="List View"></i>
									</a>
									<a href="<%=request.getContextPath()%>/jsp/categoryGrid.jsp?categoryId=<%= request.getParameter("categoryId")%>&categoryName=<%= request.getParameter("categoryName") %>&categoryDescription=<%= request.getParameter("categoryDescription") %>" class="active">
				...
				<!-- Product #1 Starts -->
					<div class="col-md-4 col-sm-6" ng-repeat="product in categoryProducts" id="{{product.productId}}">
